                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image: NetworkImage(hotel.images.isNotEmpty ? hotel.images[0] : ''),
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
  ...
  void _handleCheckout(BuildContext context, List<Hotel> trips) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('You have successfully paid \$${totalPrice.toStringAsFixed(2)} for your trips!'),
        actions: [
          TextButton(
            onPressed: () {
              // After checkout, you can clear the trips or navigate to a confirmation screen
              Provider.of<TripsProvider>(context, listen: false).clearTrips(); // Clear trips after checkout
